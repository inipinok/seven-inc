...
<h4 class="fw-bold py-3 mb-4">
  <span class="text-muted fw-light">Kost /</span> Edit
</h4>
  <div class="row">
    <div class="">
      <div class="card">
        ...
        <div class="card-body">
          <form action="{{route('kost.update', $kost->slug)}}"  method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="slug" id="slug" class="form-control  @error('slug') is-invalid @enderror required" value="{{ old('slug', $kost->slug) }}">
              @error('slug')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
            ...
            <div class="form-group">
              ...
              <input type="text" name="address" id="address" class="form-control required @error('addredd') is-invalid @enderror " value="{{ old('address', $kost->address)}}">
              @error('address')
                <p class="text-danger">
                  {{ $message }}
                </p>
            ...
            <div class="form-group">
              ...
              @enderror
              <input id="body" type="hidden" name="body" value="{{ old('body', $kost->body)}}">
              <trix-editor input="body"></trix-editor>
            </div>
            <div class="form-group mt-3">
              <label for="phone_number">No Telpon</label>
              <input name="phone_number" id="phone_number" class="form-control required" value="{{ old('phone_number', $kost->user->phone_number)}}">
            </div>
            <div class="row">
              <div class="col mt-2">
                <div class="form-group">
                  <label for="qty">Qty</label>
                  <input type="text" name="qty" id="qty" class="form-control required" value="{{ old('qty', $kost->qty)}}" >
                </div>
              </div>
              <div class="col mt-2">
                <div class="form-group">
                  <label for="price">Harga</label>
                  <input type="text" name="price" id="price" class="form-control required" value="{{ old('price' , $kost->price)}}">
                </div>
              </div>
            </div>
            <div class="form-group">
